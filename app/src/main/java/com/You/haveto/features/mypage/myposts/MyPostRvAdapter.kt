...
import com.You.haveto.databinding.ItemRvPostingBinding
import com.You.haveto.features.postdetail.PostDetailActivity
import com.You.haveto.model.PostItem
...
class MyPostRvAdapter(val context: Context): RecyclerView.Adapter<MyPostRvAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(val binding: ItemRvPostingBinding): RecyclerView.ViewHolder(binding.root){
        fun bind(item: PostItem){
            ...
            // 게시글 종류
            binding.tvPostType.text = item.postType
            binding.tvPostCatory.text = item.workOutCategory
            binding.layoutPostType.visibility = View.VISIBLE

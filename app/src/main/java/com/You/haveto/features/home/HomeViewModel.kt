package com.You.haveto.features.home

import android.util.Log
import androidx.lifecycle.LiveData
import androidx.lifecycle.MutableLiveData
import androidx.lifecycle.ViewModel
import com.You.haveto.features.diary.DiaryViewModel
import com.You.haveto.model.HomeResponse
        ...
        RetrofitClient.getApiService().patchDiaryDelete(num).enqueue(object :
            ...
            override fun onResponse(call: Call<MyResponse<Int>>, response: Response<MyResponse<Int>>) {
                ...
                if(code == 200){ // 다이어리 삭제 성공
                    val data = response.body()?.data
                    _toastMessage.postValue(com.You.haveto.network.util.DELETE_COMPLETE)
